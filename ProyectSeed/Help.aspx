...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <fieldset>
                    ...
                    <div id="tex1_ayuda" class="centrar texto Fuentes">Este apartado será su guía de ayuda para poder comprender la interfaz del software:</div>
  ...
  <div class="card">
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
        Cuenta con un Carrusel de imágenes, un poco de historia de Semillas Bibliotecas, para finalizar los botones con enlaces directos a las redes sociales.
  ...
  <div class="card">
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
      <div class="card-body">
     Dicho apartado cuenta con la información de cada perfil
