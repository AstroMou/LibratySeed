        ...
        <ContentTemplate>
            ...
            <fieldset style="overflow: hidden">
                ...
                <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <img src="ImagenesAstrosi/Fondos/ANKE.png" class="d-block w-100" alt="400">
                            <div class="carousel-caption d-none d-md-block">
                                <h1 style="color: white">Directora Anke Fängewisch, alrededor de las futuras semillas</h1>
                                <p>viernes 01 de Marzo del 2019.</p>
                            </div>
                        </div>
                        ...
                        <div class="carousel-item">
                            <img src="ImagenesAstrosi/Fondos/Cabra%20loca.png" class="d-block w-100" alt="400">
                            <div class="carousel-caption d-none d-md-block">
                                <h1 style="color: white">Cuentos y teadro móvil</h1>
                                <p>Sábado 18 de Julio del 2020.</p>
                            </div>
                        </div>
                        <%-- 3RA IMAGEN--%>
                        <div class="carousel-item">
                            <img src="ImagenesAstrosi/Fondos/villansicos.png" class="d-block w-100" alt="400">
                            <div class="carousel-caption d-none d-md-block">
                                <h1 style="color: white">Equipo semilla es un día de villancicos</h1>
                                <p>viernes 18 de Diciembre del 2020.</p>
                            </div>
                        </div>
                        <%--  4taimagen--%>
                        <div class="carousel-item">
                            <img src="ImagenesAstrosi/Fondos/biblioteca.png" class="d-block w-100" alt="400">
                            <div class="carousel-caption d-none d-md-block">
                                <h1 style="color: white">Día de cuentos</h1>
                                <p>viernes 14 de Febrero del 2020.</p>
                            </div>
                        </div>
                ...
                <div id="MisioVision" class="TarjetasUnicas centrar">
                    ...
                    <div id="tit_mis" class="col align-self-start texto Fuentes">
...
La actual administración es dirigida por Anke Fängewisch proporciona un ambiente de paz y tranquilidad donde cualquier expresión de arte o sentimientos son reconocidos y no infravalorados. Cuenta con personal diversos, en su totalidad voluntarios.
                    ...
                    <div class="card-group">
                        <div class="card">
                            <img src="ImagenesAstrosi/Fondos/donacion%201.png" class="card-img-top" alt="200">
                            <div class="card-body">
                                <h2 class="Titulopremio Fuentes">Cruz Roja</h2>
                                <div id="tit_premprueba" class="centrar textopremio Fuentes">
                        ...
                        <div class="card">
                            <img src="ImagenesAstrosi/Fondos/22.png" class="card-img-top" alt="200">
                            <div class="card-body">
                                <h2 class="Titulopremio Fuentes">Libros para Niños</h2>
                                <div id="tit_premoo" class="centrar textopremio Fuentes">
                    ...
                    <div class="mx-auto" style="width: 200px;">
                        <h3 class="Titulo Fuentes">Redes Sociales</h3>
                    </div>
                    <br />
